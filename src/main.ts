...
let currentDrive: Driver | undefined = undefined;
let config: Config | undefined = undefined;
let steps: Array<StepFromJson> | undefined = undefined;
...
async function getUserTourComplete() {
  ...
  try {
    ...
    console.log(json)
    console.log(json.tutorial.includes(completeKey))
    return json;
  } catch (error: any) {
...
async function init(_ev: Event): Promise<void> {
  ...
  console.log(userTutorialData);
  if(userTutorialData?.tutorial.includes(completeKey)){
    console.log("should not launch since completed")
    // return
  }
...
function createStep(stepFromJson: StepFromJson): DriveStep {
  let elementToClickOnNext: HTMLElement | undefined = undefined;
  ...
  let elementToClickOnPrev: HTMLElement | undefined = undefined;
  ...
  console.log(elementToClickOnNext);
  console.log(elementToClickOnPrev);
  ...
  return {
    ...
    popover: {
      ...
      onPopoverRender: getCloseLambda(),
    },
  };
}
